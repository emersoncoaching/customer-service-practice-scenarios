...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const subject = `New Customer Service Consultant scenario response: ${submission.candidate_name}`;
    const text = [
      "A new Customer Service Consultant scenario response has been submitted.",
      "",
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #23211e;">
        <h2>New Customer Service Consultant scenario response</h2>
